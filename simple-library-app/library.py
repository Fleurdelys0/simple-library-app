...
class Library:
    ...
    def __init__(self, db_file: str = "library.db") -> None:
        self.db_file = db_file
        initialize_database(self.db_file)  # Ensure DB and tables exist, and migrate if needed
        self._db_connection: Optional[sqlite3.Connection] = None
        self.books: List[Book] = self._load_books_from_db()

    def _get_db_connection(self) -> sqlite3.Connection:
        if self._db_connection is None:
            self._db_connection = get_db_connection(self.db_file)
